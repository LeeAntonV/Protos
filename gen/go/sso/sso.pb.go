...
type RegisterResponse struct {
	...
	UserId int64 `protobuf:"varint,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"` // Id of created user
}
...
type LoginRequest struct {
	...
	Email    string `protobuf:"bytes,1,opt,name=email,proto3" json:"email,omitempty"`               //Registred email
	Password string `protobuf:"bytes,2,opt,name=password,proto3" json:"password,omitempty"`         //Password assigned to email
	AppId    int32  `protobuf:"varint,3,opt,name=app_id,json=appId,proto3" json:"app_id,omitempty"` // App that user is trying to access
}
...
type CodeResponse struct {
	...
	ValidCode bool `protobuf:"varint,1,opt,name=ValidCode,proto3" json:"ValidCode,omitempty"`
}
...
func (x *CodeResponse) GetValidCode() bool {
	if x != nil {
		return x.ValidCode
	}
	return false
...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x22, 0x37, 0x0a, 0x0b, 0x43, 0x6f, 0x64, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12,
	0x14, 0x0a, 0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05,
	0x65, 0x6d, 0x61, 0x69, 0x6c, 0x12, 0x12, 0x0a, 0x04, 0x63, 0x6f, 0x64, 0x65, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x04, 0x63, 0x6f, 0x64, 0x65, 0x22, 0x2c, 0x0a, 0x0c, 0x43, 0x6f, 0x64,
	0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x1c, 0x0a, 0x09, 0x56, 0x61, 0x6c,
	0x69, 0x64, 0x43, 0x6f, 0x64, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x09, 0x56, 0x61,
	0x6c, 0x69, 0x64, 0x43, 0x6f, 0x64, 0x65, 0x32, 0xdf, 0x01, 0x0a, 0x04, 0x41, 0x75, 0x74, 0x68,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x32, 0x0a, 0x09, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x43, 0x6f,
	0x64, 0x65, 0x12, 0x11, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x43, 0x6f, 0x64, 0x65, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x12, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x43, 0x6f, 0x64,
	0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x14, 0x5a, 0x12, 0x61, 0x6e, 0x74,
	0x6f, 0x6e, 0x2e, 0x73, 0x73, 0x6f, 0x2e, 0x76, 0x31, 0x3b, 0x73, 0x73, 0x6f, 0x76, 0x31, 0x62,
...
var file_sso_sso_proto_goTypes = []interface{}{
	...
	(*CodeRequest)(nil),      // 6: auth.CodeRequest
	(*CodeResponse)(nil),     // 7: auth.CodeResponse
}
var file_sso_sso_proto_depIdxs = []int32{
	0, // 0: auth.Auth.Register:input_type -> auth.RegisterRequest
	2, // 1: auth.Auth.Login:input_type -> auth.LoginRequest
	4, // 2: auth.Auth.IsAdmin:input_type -> auth.IsAdminRequest
	6, // 3: auth.Auth.ValidCode:input_type -> auth.CodeRequest
	...
	7, // 7: auth.Auth.ValidCode:output_type -> auth.CodeResponse
